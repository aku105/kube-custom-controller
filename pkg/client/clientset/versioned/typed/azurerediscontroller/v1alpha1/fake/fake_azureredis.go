...
type FakeAzureRedises struct {
	Fake *FakeAzurerediscontrollerV1alpha1
}

var azureredisesResource = schema.GroupVersionResource{Group: "azurerediscontroller", Version: "v1alpha1", Resource: "azureredises"}

var azureredisesKind = schema.GroupVersionKind{Group: "azurerediscontroller", Version: "v1alpha1", Kind: "AzureRedis"}
