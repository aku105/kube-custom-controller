...
import (
	...
	scheme "github.com/amitkr0201/kube-custom-controller/pkg/client/clientset/versioned/scheme"
...
func newAzureRedises(c *AzurerediscontrollerV1alpha1Client) *azureRedises {
	return &azureRedises{
		client: c.RESTClient(),
	}
}
