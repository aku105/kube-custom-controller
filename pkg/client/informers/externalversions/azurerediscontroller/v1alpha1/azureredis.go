...
import (
	...
	azurerediscontroller_v1alpha1 "github.com/amitkr0201/kube-custom-controller/pkg/apis/azurerediscontroller/v1alpha1"
	versioned "github.com/amitkr0201/kube-custom-controller/pkg/client/clientset/versioned"
	internalinterfaces "github.com/amitkr0201/kube-custom-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/amitkr0201/kube-custom-controller/pkg/client/listers/azurerediscontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurerediscontrollerV1alpha1().AzureRedises().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurerediscontrollerV1alpha1().AzureRedises().Watch(options)
			},
		},
		&azurerediscontroller_v1alpha1.AzureRedis{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *azureRedisInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurerediscontroller_v1alpha1.AzureRedis{}, f.defaultInformer)
}
